...
/**
 * Argument Validator is to validate the method arguments before using it, also to minimize the
 * duplicating of if statement inside each setter method or a method that has an argument.
 */
