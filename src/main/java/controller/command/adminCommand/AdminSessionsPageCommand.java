...
public class AdminSessionsPageCommand implements ICommand {
  ...
  private static final Logger logger = Logger.getLogger(AdminSessionsPageCommand.class);
  ...
  public String execute(HttpServletRequest request, HttpServletResponse response)
    ...
    request.setAttribute(
        "numberSpectators", seatService.getNumberBusySeatAllSessionByMovieId(movieId));
    request.setAttribute(
        "movie",
