...
public class SeatsPageCommand implements ICommand {
  ...
  private static final Logger logger = Logger.getLogger(SeatsPageCommand.class);
  ...
  public String execute(HttpServletRequest request, HttpServletResponse response)
    ...
    request.setAttribute(
        "session",
        sessionService.findByIdAndLanguageId(
            sessionId, (Long) request.getSession().getAttribute("dbLanguage")));
