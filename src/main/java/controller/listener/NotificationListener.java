...
public class NotificationListener implements HttpSessionAttributeListener {
   ...
   *
   * @param event the HttpSessionBindingEvent containing the session and the name and value of the
   *     attribute that was added
   */
  @Override
  public void attributeAdded(final HttpSessionBindingEvent event) {
    StringBuilder sb = new StringBuilder();
    sb.append("Session attribute added: ")
  ...
  /**
   * Receives notification that an attribute has been changed from a session.
   *
   * @param event the HttpSessionBindingEvent containing the session and the name and value of the
  ...
  public void attributeRemoved(final HttpSessionBindingEvent event) {
    StringBuilder sb = new StringBuilder();
    sb.append("Session attribute removed: ")
        .append(event.getClass().getSimpleName())
        .append(" : ")
        .append(event.getName())
        .append(" : ")
